...
// No hover:scale-110 here — these buttons are flex-1 (full-width within
// their row), so growing on hover has nowhere to go but into the adjacent
// button. active:scale-90 is safe since shrinking always pulls inward.
const GHOST_BUTTON =
  "pfm-interactive flex flex-1 h-16 items-center justify-center rounded-full text-foreground hover:bg-[var(--surface)] active:bg-transparent active:scale-90 active:opacity-60 focus-visible:outline-none focus-visible:shadow-[0_0_0_3px_rgba(255,255,255,0.3)] disabled:pointer-events-none disabled:opacity-30";
    ...
    <div className="pointer-events-auto flex w-full flex-col gap-4">
      ...
      <div className="flex w-full items-center gap-1">
        ...
        <button
          ...
          onClick={togglePlay}
          disabled={!track}
          className="pfm-interactive flex h-16 flex-1 items-center justify-center rounded-full border border-[var(--border-input)] text-foreground hover:bg-[var(--surface)] active:bg-transparent active:scale-90 active:opacity-60 focus-visible:outline-none focus-visible:border-[var(--surface-border)] focus-visible:shadow-[0_0_0_3px_rgba(255,255,255,0.3)] disabled:pointer-events-none disabled:opacity-30"
        >
