    ...
    <div className="relative shrink-0" style={{ width: SPINE_WIDTH }}>
      ...
      >
        ...
        <button
          ...
          className="flex size-9 items-center justify-center rounded-full text-foreground transition-colors duration-150 hover:bg-[var(--surface)] active:bg-transparent active:opacity-60 focus-visible:outline-none focus-visible:shadow-[0_0_0_3px_rgba(255,255,255,0.3)]"
        >
